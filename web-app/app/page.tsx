...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-6 text-center">
      <h1 className="text-4xl font-semibold mb-4">Practical Assignment</h1>
      ...
      <div className="flex gap-4">
        ...
        <Link href="/register" className="px-6 py-2 rounded-full bg-white border text-sm hover:bg-gray-100 transition">
          Register
        </Link>
      </div>
    </main>
